...
\cventry{07/2025--maintenant}{Développeur}{\href{https://www.unowhy.com}{Unowhy}}{Neuilly-sur-Seine 92200}{CDI}{
    \begin{itemize}
        \item Maintenance applicative et évolutions fonctionnelles de la suite SQOOL (Python, PostgreSQL)
    \end{itemize}
}

\cventry{01/2025--07/2025}{Développeur}{\href{https://www.freepro.com}{FreePRO}}{Paris 75008}{CDI}{
    \begin{itemize}
        \item Maintenance applicative et évolutions fonctionnelles (Perl, PHP, PostgreSQL)
    \end{itemize}
}

\cventry{2018--10/2024}{Développeur back-end}{\href{https://alphanetworks.tv}{Alphanetworks}}{Paris 75001}{CDI}{
    \begin{itemize}
...
\cventry{2016--2018}{Développeur Android}{Mobile Media Com}{Paris 75001}{CDI}{Développement d'applications de \emph{streaming vidéo} (similaires à YouTube) sous Android compatibles téléphones, tablettes et télés (Android TV) : \href{https://www.playzer.fr}{Playzer}, Replay TV France
    \begin{itemize}
...
\cventry{2010--2011}{Développeur back-end/front-end}{3DS (Dassault Systèmes)}{Vélizy-Villacoublay 78140}{Contrat d'apprentissage en Alternance}{
    ...
    \begin{itemize}
        \item nouvelle fonctionnalité notable : génération de PDFs à la volée pour la gestion des changements de matériel
        \item correction de bugs
    \end{itemize}
}

\cventry{2008--2010}{Développeur back-end/front-end}{\href{https://www.maecia.com}{Maecia}}{Paris 75002}{Contrat d'apprentissage en Alternance}{Développement de sites e-commerce et de communication (PHP (eZ Publish, Joomla!), SQL (MySQL/MariaDB), JavaScript (Mootools)}

\section{Formations}

\cventry{$\infty$}{Auto-formation, veille technologique}{}{}{}{}

\cventry{2023}{Formation \emph{manager}}{}{}{}{Formation d'une journée dans le cadre de mon statut de maître d'apprentissage.}
...
\cventry{2007--2008}{1ère année Licence Science du Vivant}{Université Paris 7}{}{}{Objectif avorté : spécialisation en bioinformatique}
