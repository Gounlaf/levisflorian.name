...
\mobile{+33 6 84 94 25 85}
\email{levis.florian@gmail.com}
\extrainfo{\theage{} ans, permis B, véhiculé\\mais en métro ou à pieds c'est mieux}
\homepage{https://levisflorian.name}
\social[github][https://github.com/Gounlaf]{github.com/Gounlaf}
\social[linkedin][https://www.linkedin.com/in/gounlaf/]{linkedin.com/in/gounlaf}
...
\cventry{2011--2016}{Développeur fullstack}{\smartandgeek}{Paris 75020}{Contrat d'apprentissage en Alternance (1 an) puis CDI}{
    \begin{itemize}
        ...
        \begin{itemize}
            \item JobAroundMe (PHP/Zend Framework 2)
            \begin{itemize}
            ...
            \end{itemize}
            \item Dynamic-Cover (PHP/Zend Framework 2, Fabric.js)
            \begin{itemize}
...
\cvitem{\textbf{Environnement}}{\mbox{Ubuntu}, \mbox{JetBrains All Products Pack}, \mbox{macOS}}
...
\cvitem{Loisirs}{Escalade (passport blanc), Plongée sous-marine (Niveau 2 FFESSM)}
